...
define(['src/main/datas', 'src/util/api', 'src/util/ui', 'src/util/util', 'src/util/debug', 'superagent', 'uri/URI', 'lodash', 'src/util/couchdbAttachments', 'src/util/mimeTypes', 'src/util/IDBKeyValue', 'eventEmitter', './UserViewPrefs', './UserAnalysisResults'], function (Datas, API, ui, Util, Debug, superagent, URI, _, CDB, mimeTypes, IDB, EventEmitter, UserViewPrefs, UserAnalysisResults) {
  ...
  var getTypes = ['get', 'getAttachment', 'getView', 'getQuery', 'getTokens', 'getGroups', 'getToken'];
  var messagesByType = {
    get: {
  ...
  var Roc = /*#__PURE__*/function () {
    ...
    _createClass(Roc, [{
      ...
      value: function () {
        var _getGroupMembership = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13(options) {
          var url;
            ...
            while (1) {
              switch (_context13.prev = _context13.next) {
                ...
                case 3:
                  ...
                  return _context13.abrupt("return", superagent.get(url).withCredentials().then(function (res) {
                    return res.body;
                  })["catch"](handleError(this, options)));
        ...
        function getGroupMembership(_x16) {
      ...
      key: "create",
      value: function () {
        var _create = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14(entry, options) {
          var _this5 = this;
            ...
            while (1) {
              switch (_context14.prev = _context14.next) {
                ...
                case 2:
                  ...
                  return _context14.abrupt("return", superagent.post(this.entryUrl).withCredentials().send(entry).then(handleSuccess(this, options)).then(function (res) {
      ...
      key: "update",
      value: function () {
        var _update = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee15(entry, options) {
          var _this6 = this;
            ...
            while (1) {
              switch (_context15.prev = _context15.next) {
                ...
                case 2:
                  ...
                  return _context15.abrupt("return", superagent.put("".concat(this.entryUrl, "/").concat(String(entry._id))).withCredentials().send(reqEntry).then(handleSuccess(this, options)).then(function (res) {
                    if (res.body && res.status === 200) {
      ...
      value: function () {
        var _deleteAttachment = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee16(entry, attachments, options) {
            ...
            while (1) {
              switch (_context16.prev = _context16.next) {
                ...
                case 36:
                  ...
                  return _context16.abrupt("return", handleError(this, options)(_context16.t0));
          ...
          }, _callee16, this, [[13, 36]]);
        }));

        function deleteAttachment(_x21, _x22, _x23) {
      ...
      key: "unattach",
      value: function () {
        var _unattach = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee17(entry, row, options) {
        ...
        function unattach(_x24, _x25, _x26) {
      ...
      value: function () {
        var _processAttachment2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee18(type, attachment) {
        ...
        function _processAttachment(_x27, _x28) {
      ...
      key: "attachBulk",
      value: function () {
        var _attachBulk = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee19(type, entry, attachments, options) {
            ...
            while (1) {
              switch (_context19.prev = _context19.next) {
                ...
                case 2:
                  ...
                  return _context19.abrupt("return", this.attach(type, entry, attachments[0], options));
                ...
                case 35:
                  ...
                  return _context19.abrupt("return", handleError(this, attachOptions)(_context19.t0));
        ...
        function attachBulk(_x29, _x30, _x31, _x32) {
      ...
      key: "attach",
      value: function () {
        var _attach = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee20(type, entry, attachment, options) {
            ...
            while (1) {
              switch (_context20.prev = _context20.next) {
                ...
                case 23:
                  ...
                  return _context20.abrupt("return", handleError(this, attachOptions)(_context20.t0));
        ...
        function attach(_x33, _x34, _x35, _x36) {
      ...
      key: "discardLocal",
      value: function () {
        var _discardLocal = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee21(entry) {
            ...
            while (1) {
              switch (_context21.prev = _context21.next) {
                ...
                case 13:
                  ...
                  return _context21.abrupt("return", serverEntry);
      ...
      key: "getAttachment",
      value: function () {
        var _getAttachment = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee22(entry, name, options) {
          var cdb;
            ...
            while (1) {
              switch (_context22.prev = _context22.next) {
                ...
                case 2:
                  ...
                  cdb = this._getCdb(entry);
                  return _context22.abrupt("return", cdb.get(name)["catch"](handleError(this, options)));
        ...
        function getAttachment(_x38, _x39, _x40) {
      ...
      value: function () {
        var _getAttachmentList = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee23(entry) {
          var cdb;
          return regeneratorRuntime.wrap(function _callee23$(_context23) {
            while (1) {
              switch (_context23.prev = _context23.next) {
                ...
                case 2:
                  cdb = this._getCdb(entry);
                  return _context23.abrupt("return", cdb.list());
        ...
        function getAttachmentList(_x41) {
      ...
      value: function () {
        var _updateAttachmentList = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee24(entry) {
          var cdb;
          return regeneratorRuntime.wrap(function _callee24$(_context24) {
            while (1) {
              switch (_context24.prev = _context24.next) {
                ...
                case 5:
                  entry.attachmentList = _context24.sent;
        ...
        function updateAttachmentList(_x42) {
      ...
      key: "addAttachment",
      value: function () {
        var _addAttachment = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee25(entry, attachments, options) {
            ...
            while (1) {
              switch (_context25.prev = _context25.next) {
                ...
                case 44:
                  ...
                  return _context25.abrupt("return", handleError(this, options)(_context25.t0));
          ...
          }, _callee25, this, [[28, 44]]);
        }));

        function addAttachment(_x43, _x44, _x45) {
      ...
      value: function () {
        var _addAttachmentById = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee26(id, attachment, options) {
          var doc;
          return regeneratorRuntime.wrap(function _callee26$(_context26) {
            while (1) {
              switch (_context26.prev = _context26.next) {
                ...
                case 6:
                  return _context26.abrupt("return", this.addAttachment(doc._id, attachment, options));
        ...
        function addAttachmentById(_x46, _x47, _x48) {
      ...
      key: "getTokens",
      value: function () {
        var _getTokens = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee27(options) {
          var tokenUrl;
            ...
            while (1) {
              switch (_context27.prev = _context27.next) {
                ...
                case 2:
                  ...
                  return _context27.abrupt("return", superagent.get(tokenUrl).withCredentials().then(handleSuccess(this, options)).then(function (res) {
                    return res.body;
                  })["catch"](handleError(this, options)));
      ...
      key: "getToken",
      value: function () {
        var _getToken = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee28(token, options) {
            ...
            while (1) {
              switch (_context28.prev = _context28.next) {
                ...
                case 2:
                  ...
                  return _context28.abrupt("return", superagent.get(tokenUrl).withCredentials().then(handleSuccess(this, options)).then(function (res) {
                    return res.body;
                  })["catch"](handleError(this, options)));
      ...
      key: "createToken",
      value: function () {
        var _createToken = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee29(entry, options) {
          var uuid;
            ...
            while (1) {
              switch (_context29.prev = _context29.next) {
                ...
                case 2:
                  ...
                  uuid = getUuid(entry);
                  return _context29.abrupt("return", superagent.post("".concat(this.entryUrl, "/").concat(uuid, "/_token")).withCredentials().then(handleSuccess(this, options)).then(function (res) {
                    return res.body;
                  })["catch"](handleError(this, options)));
        ...
        function createToken(_x52, _x53) {
      ...
      key: "createUserToken",
      value: function () {
        var _createUserToken = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee30(options) {
          var request;
            ...
            while (1) {
              switch (_context30.prev = _context30.next) {
                ...
                case 2:
                  ...
                  return _context30.abrupt("return", request.then(handleSuccess(this, options)).then(function (res) {
                    return res.body;
                  })["catch"](handleError(this, options)));
      ...
      key: "deleteToken",
      value: function () {
        var _deleteToken = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee31(token, options) {
          var tokenId, tokenUrl;
            ...
            while (1) {
              switch (_context31.prev = _context31.next) {
                ...
                case 2:
                  ...
                  tokenId = getTokenId(token);
                  tokenUrl = new URI(this.databaseUrl).segment("token/".concat(tokenId)).normalize().href();
                  return _context31.abrupt("return", superagent.del(tokenUrl).withCredentials().then(handleSuccess(this, options)).then(function (res) {
                    return res.body;
                  })["catch"](handleError(this, options)));
        ...
        function deleteToken(_x55, _x56) {
      ...
      key: "addGroup",
      value: function () {
        var _addGroup = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee32(entry, group, options, remove) {
          var _this7 = this;
            ...
            while (1) {
              switch (_context32.prev = _context32.next) {
                ...
                case 7:
                  ...
                  return _context32.abrupt("return", superagent[method]("".concat(this.entryUrl, "/").concat(uuid, "/_owner/").concat(String(group))).withCredentials().then(handleSuccess(this, options)).then(function (res) {
                    if (!options.noUpdate) {
        ...
        function addGroup(_x57, _x58, _x59, _x60) {
      ...
      key: "delete",
      value: function () {
        var _delete2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee33(entry, options) {
          var _this8 = this;
            ...
            while (1) {
              switch (_context33.prev = _context33.next) {
                ...
                case 2:
                  ...
                  return _context33.abrupt("return", superagent.del("".concat(this.entryUrl, "/").concat(uuid)).withCredentials().then(handleSuccess(this, options)).then(function (res) {
                    if (res.body && res.status === 200) {
      ...
      key: "typeUrl",
      value: function typeUrl(v, entry) {
        var _this9 = this;
