...
define(["module", "superagent"], function (module) {
  ...
  module.exports = function (url) {
    ...
    function _makeblastdb() {
      _makeblastdb = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(sequences) {
        var res;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _superagent["default"].post("".concat(url, "/makeblastdb")).send(sequences);
    ...
    function _blastn() {
      _blastn = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(options) {
        var res;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return _superagent["default"].post("".concat(url, "/blastn")).send(options);
    ...
    function _createSequencesDatabase() {
      _createSequencesDatabase = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(roc) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                ...
                _context3.next = 9;
                return _superagent["default"].post("".concat(url, "/makeblastdb")).send({
                  seq: toSend
                });
    ...
    function _createFeaturesDatabase() {
      _createFeaturesDatabase = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(roc) {
