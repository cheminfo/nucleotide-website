...
define(["module", "src/util/api", "../rest-on-couch/Roc"], function (module) {
  ...
  function onDataFocus(dataId, tabId, type) {
    return function (data) {
      if (data.type === 'tab.focus') {
        ...
        if (type === 'data') _data = _api["default"].getData(dataId);else if (type === 'cache') _data = _api["default"].cache(dataId);
