...
define(["module", "openchemlib/openchemlib-core", "src/util/ui", "lodash"], function (module) {
  var _openchemlibCore = _interopRequireDefault();
  ...
  module.exports = function (roc, prefix) {
    function getMoleculeWithSalts(options) {
      ...
      var mol = _openchemlibCore["default"].Molecule.fromIDCode(oclid);

      if (saltCode !== 'NX' && oclid !== 'd@') {
        var salt = salts[saltCode];

        if (salt) {
          var oclSalt = _openchemlibCore["default"].Molecule.fromIDCode(String(salt.idCode));
    ...
    function getOclDistinguishOr(mol) {
      var idCode = mol.getCanonizedIDCode(_openchemlibCore["default"].Molecule.CANONIZER_DISTINGUISH_RACEMIC_OR_GROUPS);
    ...
    function _updateInternalDocumentWithNewStructure() {
      _updateInternalDocumentWithNewStructure = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(doc, newOcl) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                general = doc.$content.general; // structure

                freeBaseMolecule = _openchemlibCore["default"].Molecule.fromIDCode(newOclid);
    ...
    function _updateInternalStructureByUpdate() {
      _updateInternalStructureByUpdate = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(docId, newOcl) {
        var doc;
    ...
    function _updateInternalStructure() {
      _updateInternalStructure = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(oldOclid, newOcl) {
    ...
    function _getNextID() {
      _getNextID = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    ...
    function _getDups() {
      _getDups = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(oclid) {
        var oclidStr, dups;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 6:
                ...
                return _context5.abrupt("return", _lodash["default"].uniqBy(dups, function (dup) {
    ...
    function _getInternalIDInfo() {
      _getInternalIDInfo = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(oclid, salt) {
    ...
    function _getNextSampleWithSaltID() {
      _getNextSampleWithSaltID = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(oclid, salt) {
        var info;
    ...
    function _getNextSampleID() {
      _getNextSampleID = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(oclid) {
