...
define(["module", "openchemlib/openchemlib-core"], function (module) {
  ...
  function getOcl(molfile, throwIfEmpty) {
    ...
    var ocl = _openchemlibCore["default"].Molecule.fromMolfile(molfile);
  ...
  function _getNextId() {
    _getNextId = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(roc, viewName, type) {
