...
define(["module", "lodash", "src/util/ui", "./chemspider", "./chemexper", "./epfl"], function (module) {
  var _lodash = _interopRequireDefault();

  var _ui = _interopRequireDefault();

  var _chemspider = _interopRequireDefault();

  var _chemexper = _interopRequireDefault();

  var _epfl = _interopRequireDefault();
  ...
  module.exports = {
    chemspider: _chemspider["default"],
    chemexper: _chemexper["default"],
    epfl: _epfl["default"],
    choose: function choose(term, options) {
      ...
      if (options.epfl) {
        sources.push({
          promise: _epfl["default"].search(term)
        });
      }

      if (options.chemspider) {
        sources.push({
          promise: _chemspider["default"].search(term)
        });
      }

      if (options.chemexper) sources.push({
        promise: _chemexper["default"].search(term)
      });
      ...
      if (options.roc) {
        ...
        var rocPromise = roc.view('entryByKindAndId', {
          ...
          data.forEach(function (d) {
            ...
            d.id = d._id;
            d.source = 'sample';
            d.names = _lodash["default"].uniq(names);
          });
          return data;
        });
        sources.push({
      ...
      return _ui["default"].choose(sources, {
