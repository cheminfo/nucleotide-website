...
define(["module", "superagent", "src/util/util", "src/util/ui", "lodash"], function (module) {
  ...
  module.exports = {
    search: function search(term) {
      return _superagent["default"].get("http://stock-isic.epfl.ch/searchstock?for=json&bl=100&search=Field10.11%3D".concat(encodeURIComponent(term))).then(function (result) {
  ...
  function fromExpereact(expereact) {
    ...
    return {
      ...
      names: _lodash["default"].uniq([expereact.name].concat(_toConsumableArray(expereact.row.iupac.map(function (i) {
        return i.value;
      })))),
      source: 'reference'
    };
