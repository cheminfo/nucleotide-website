...
define(["module", "./printer"], function (module) {
  var _printer = _interopRequireDefault();
  ...
  module.exports = function (opts, cb) {
    ...
    if (typeof IframeBridge !== 'undefined') {
      self.IframeBridge.onMessage( /*#__PURE__*/function () {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.next = 7;
                  return (0, _printer["default"])(options);
