...
define(["exports", "../libs/MolecularFormula"], function (exports) {
  ...
  function formatExactMass(value) {
    ...
    var mfInfo = new _MolecularFormula["default"].MF("".concat(accurate.mf, "(").concat(accurate.modification, ")")).getInfo();
    var modificationInfo = new _MolecularFormula["default"].MF(String(accurate.modification)).getInfo();
    var result = [];
    var experiment = [];
    ...
    var modificationMF = new _MolecularFormula["default"].MF(modificationInfo.mf.replace(/\(.*/, '')).toHtml();
