...
define(["module", "src/util/api", "src/util/versioning", "uri/URI"], function (module) {
  var _api = _interopRequireDefault();

  var _versioning = _interopRequireDefault();

  var _URI = _interopRequireDefault();
  ...
  function _track() {
    _track = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _api["default"].createData('nmr', []);

              _api["default"].createData('mass', []);

              _api["default"].createData('ir', []);

              uri = new _URI["default"](document.location.href);
              ...
              data = _versioning["default"].getData();
              ...
              _context.next = 13;
              return _api["default"].require('vh/eln/libs/OCLE');
            ...
            case 13:
              ...
              _api["default"].createData('molfile', molecule.toMolfile());
            ...
            case 19:
              ...
              _api["default"].createData('molfile', _molecule.toMolfile());
            ...
            case 28:
              ...
              _api["default"].createData('molfile', sample.molfile);
            ...
            case 34:
              ...
              if (sample.molfile) {
                ...
                _api["default"].createData('molfile', '');
              }
