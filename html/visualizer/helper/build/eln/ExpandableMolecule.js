...
define(["module", "src/util/api", "src/util/ui", "./libs/OCLE"], function (module) {
  ...
  var ExpandableMolecule = /*#__PURE__*/function () {
    function ExpandableMolecule(sample, options) {
      ...
      this.idCode = _OCLE["default"].Molecule.fromMolfile(this.molfile).getIDCode();
      ...
      this.onChange = function (event) {
        ...
        var newMolecule = _OCLE["default"].Molecule.fromMolfile("".concat(event.target));
      ...
      _api["default"].createData('editableMolfile', this.molfile).then(function (editableMolfile) {
    ...
    _createClass(ExpandableMolecule, [{
      ...
      value: function toggleJSMEEdition() {
        ...
        if (this.jsmeEditionMode) {
          ...
          _api["default"].createData('editableMolfile', this.molfile);
        } else {
          options.prefs.push('depict');
          this.createViewVariable();
        }

        _api["default"].doAction('setJSMEOptions', options);
      }
    }, {
      ...
      value: function createViewVariable() {
        var molecule = _OCLE["default"].Molecule.fromMolfile(this.molfile);
        ...
        if (this.expandedHydrogens) {
          ...
          _api["default"].createData('viewMolfileExpandedH', viewMolfileExpandedH);
        } else {
          ...
          _api["default"].createData('viewMolfile', viewMolfile);
        }
      }
    }, {
      key: "setMolfile",
      value: function setMolfile(molfile) {
        var editableMolfile = _api["default"].getData('editableMolfile');
      ...
      value: function () {
        var _loadMolfileFromHistory = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.next = 3;
                  return _ui["default"].choose(history, {
                    autoSelect: false,
                    noConfirmation: true,
                    returnRow: true,
                    dialog: {
      ...
      value: function handleAction(action) {
        ...
        switch (action.name) {
          ...
          case 'clearMolfile':
            var molfile = _api["default"].getData('editableMolfile');
