...
define(["exports", "src/util/api", "src/util/ui", "./Status"], function (exports) {
  ...
  var _Status = _interopRequireDefault();
  ...
  function _processAction() {
    _processAction = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(actionName, actionValue) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 9:
              request = _api["default"].getData('request');
              _context.next = 12;
            ...
            case 15:
              ...
              _api["default"].doAction('refreshRequests');
            ...
            case 20:
              refreshRequests(_api["default"].getData('preferences'));
              return _context.abrupt("break", 31);
            ...
            case 24:
              _context.next = 26;
              return bulkChangeStatus(_api["default"].getData('selected'));

            case 26:
              _api["default"].doAction('refreshRequests');

              _api["default"].createData('status', []);

              _api["default"].doAction('setSelected', []);
  ...
  function _requestFromScan() {
    _requestFromScan = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(scan) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              _api["default"].createData('request', {});

              return _context2.abrupt("return");

            case 6:
              _api["default"].createData('request', request);

              _context2.next = 9;
              return _api["default"].getVar('request');

            case 9:
              requestVar = _context2.sent;

              _api["default"].setVariable('status', requestVar, ['$content', 'status']);
  ...
  function _refreshRequests() {
    _refreshRequests = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(options) {
          ...
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              if (String(options.status) !== 'any') {
                statusCode = _Status["default"].getStatusCode(String(options.status));
            ...
            case 5:
              ...
              results.forEach(function (result) {
                result.color = _Status["default"].getStatusColor(Number(result.value.status.status));
              });

              _api["default"].createData('requests', results);
  ...
  function _bulkChangeStatus() {
    _bulkChangeStatus = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(selected) {
  ...
  function _askNewStatus() {
    _askNewStatus = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(request) {
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              statusArray = _Status["default"].getStatusArray();
              currentStatus = -1;
  ...
  function _prependStatus() {
    _prependStatus = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(request, newStatus) {
  ...
  function _createForm() {
    _createForm = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 2:
              ...
              possibleStatus = ['any'].concat(_Status["default"].getStatusArray().map(function (s) {
              ...
              _api["default"].createData('formSchema', schema);
