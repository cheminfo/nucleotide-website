...
define(["exports", "src/main/datas", "src/util/api"], function (exports) {
  ...
  function createVar(variable, varName) {
    ...
    _api["default"].setVariable(varName, variable, jpaths[varName]);
  }
  ...
  function _getData(variable) {
    if (DataObject.getType(variable) === 'string') {
      return _api["default"].getData(variable);
    }
