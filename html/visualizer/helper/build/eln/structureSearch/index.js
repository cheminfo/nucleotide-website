...
define(["module", "src/util/api", "../libs/OCLE"], function (module) {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 10:
                _api["default"].loading('mol', "Loading molecules (".concat(i + 1, "/").concat(l, ")"));
