...
define(["module", "./jpaths", "src/main/datas", "src/util/api", "src/util/ui", "../rest-on-couch/Roc", "./libs/elnPlugin"], function (module, _jpaths) {
  ...
  var BioReaction = /*#__PURE__*/function () {
    ...
    _createClass(BioReaction, [{
      ...
      value: function () {
        var _loadInstanceInVisualizer2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
          var sampleVar;
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 2:
                  ...
                  sampleVar = _api["default"].getVar(this.options.varName);
      ...
      key: "handleOverview",
      value: function () {
        var _handleOverview = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(variableName) {
          var data, file;
      ...
      key: "handleDrop",
      value: function () {
        var _handleDrop = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(name, askType) {
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 15:
                  ...
                  droppedDatas = _api["default"].getData(name);
      ...
      key: "handleAction",
      value: function () {
        var _handleAction = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(action) {
      ...
      key: "attachFiles",
      value: function () {
        var _attachFiles = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(files, type) {
          var i, data;
