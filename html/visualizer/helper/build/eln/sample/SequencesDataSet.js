...
define(["module", "src/util/api", "src/util/ui", "lodash", "src/util/versioning", "src/util/color", "../../util/md5"], function (module) {
  ...
  var SequencesDataSet = /*#__PURE__*/function () {
    ...
    _createClass(SequencesDataSet, [{
                ...
                case 13:
                  ...
                  mainData.onChange(function (evt) {
                    if (evt.jpath[0] === varName) {
                      ...
                      var selectedSequences = _api["default"].getData('selectedSequences');
          ...
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 14:
                  selectedSequences = _api["default"].getData('selectedSequences');
                ...
                case 19:
                  _selectedSequences = _api["default"].getData('selectedSequences');
                ...
                case 36:
                  _selectedSequences2 = _api["default"].getData('selectedSequences');
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  ...
                  _api["default"].createData('sequences', []);
                ...
                case 6:
                  ...
                  _api["default"].createData('sequences', sequences);
      ...
      value: function showAllSpectra() {
        ...
        _api["default"].getData('selectedSequences').triggerChange();
      }
    }, {
      key: "hideAllSpectra",
          ...
          return regeneratorRuntime.wrap(function _callee4$(_context4) {
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  selectedSequences = _api["default"].getData('selectedSequences'); // count the number of sampleIDs to determine the number of colros
      ...
      value: function () {
        var _addSequenceToSelected = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(seq, tocEntry, selectedSequences) {
            ...
            while (1) {
              switch (_context5.prev = _context5.next) {
                case 0:
                  ...
                  hash = (0, _md["default"])(seq.sequence).substring(0, 8);
