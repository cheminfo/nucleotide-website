...
define(["module", "exports", "src/util/api"], function (module, exports) {
  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.RangesManager = void 0;
  ...
  var RangesManager = /*#__PURE__*/function () {
    ...
    _createClass(RangesManager, [{
      ...
      value: function updateAnnotations(track) {
        if (!this.ranges || this.ranges.length === 0) {
          _api["default"].createData('rangeAnnotations', []);
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            if (updateHighlight) {
              _api["default"].getData('ranges').triggerChange();
            }
          }
        } catch (err) {
          _iterator.e(err);
        ...
        _api["default"].createData('rangeAnnotations', annotations);
      }
    }, {
      key: "setLabel",
  ...
  exports.RangesManager = RangesManager;
