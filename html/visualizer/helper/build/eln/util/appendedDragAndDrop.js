...
define(["exports", "src/util/api", "../libs/elnPlugin"], function (exports) {
  ...
  function appendedDragAndDrop(experimentalFiles, targetName) {
    var target = _api["default"].getData(targetName);
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        if (file.filename && String(file.filename) !== '') {
          ...
          var property = _elnPlugin["default"].util.getTargetProperty(String(file.filename));
    ...
    if (newTarget) {
      _api["default"].createData(targetName, target);
    } else {
