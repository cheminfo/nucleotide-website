...
define(["module", "../libs/jcampconverter", "src/util/ui"], function (module, _jcampconverter) {
  ...
  function _jcampInfo() {
    _jcampInfo = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(value) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              for (_i = 0, _Object$keys = Object.keys(parsed.info); _i < _Object$keys.length; _i++) {
                key = _Object$keys[_i];
                _value = parsed.info[key];
