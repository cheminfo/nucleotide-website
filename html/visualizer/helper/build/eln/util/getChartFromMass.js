...
define(["exports", "../libs/jcampconverter", "../libs/parseXY"], function (exports, _jcampconverter, _parseXY) {
  ...
  function _getChartFromMass() {
    _getChartFromMass = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(experiment) {
      var options,
          name,
          data,
          jcamp,
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 12:
              data = _context.t0;
              jcamp = String(data);
              result = (0, _jcampconverter.convert)(jcamp, {
                xy: true
              });
              points = result.spectra[0].data[0];
