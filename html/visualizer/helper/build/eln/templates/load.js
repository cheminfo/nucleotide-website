...
define(["module", "src/util/api"], function (module) {
  ...
  module.exports = /*#__PURE__*/function () {
    var _loadTemplates = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(categories) {
      var options,
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 7;
              return fetch("".concat(roc.url, "/db/templates/_query/template?key=abcdef")).then( /*#__PURE__*/function () {
            ...
            case 12:
              ...
              _context3.next = 16;
              return _api["default"].createData(variableName, templates);
  ...
  function _fetchAndLink() {
    _fetchAndLink = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
      var url,
          categories,
          templates,
          _iterator,
