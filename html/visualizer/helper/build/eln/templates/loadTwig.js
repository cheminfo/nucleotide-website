...
define(["module", "src/util/api", "./load"], function (module) {
  var _api = _interopRequireDefault();

  var _load = _interopRequireDefault();
  ...
  module.exports = /*#__PURE__*/function () {
    var _loadTwig = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(category) {
      var options,
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 6;
              return (0, _load["default"])([category]);
            ...
            case 10:
              ...
              if (variableName) _api["default"].createData(variableName, twigTemplate);
              return _context.abrupt("return", twigTemplate);

            case 15:
              _context.prev = 15;
              _context.t2 = _context["catch"](2); // eslint-disable-next-line no-console
