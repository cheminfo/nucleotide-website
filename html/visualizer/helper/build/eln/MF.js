...
define(["module", "src/util/api", "src/util/ui", "./libs/OCLE", "./libs/MolecularFormula"], function (module) {
  ...
  var MF = /*#__PURE__*/function () {
    ...
    _createClass(MF, [{
      ...
      value: function getIsotopicDistributionInstance(options) {
        ...
        return new _MolecularFormula["default"].IsotopicDistribution(this.getMF(), options);
      }
    }, {
      key: "setCanonizedMF",
      value: function setCanonizedMF(mf) {
        _api["default"].createData('canonizedMF', mf);
      }
    }, {
      ...
      value: function fromMolfile() {
        ...
        _api["default"].createData('mfBGColor', 'white');
      }
    }, {
      ...
      value: function _mfInfoFromMolfile() {
        ...
        if (molfile) {
          var molecule = _OCLE["default"].Molecule.fromMolfile(molfile);
          ...
          try {
            ...
            if (mf !== '') {
              _ui["default"].showNotification("Could not calculate molecular formula: ".concat(e));
            }
          }
        }
      ...
      value: function fromMF() {
        try {
          ...
          var mfInfo = new _MolecularFormula["default"].MF(this.getMF()).getInfo();
      ...
      value: function _mfColor() {
        ...
        if (molfile) {
          ...
          var existingMW = existingMF ? new _MolecularFormula["default"].MF(existingMF).getInfo().mw : 0;
          var newMW = mf ? new _MolecularFormula["default"].MF(mf).getInfo().mw : 0;

          if (newMW !== existingMW) {
            _api["default"].createData('mfBGColor', 'pink');
          } else {
            _api["default"].createData('mfBGColor', 'white');
          }
        } else {
