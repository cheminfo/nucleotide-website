...
define(["exports", "lib/twigjs/twig", "angularplasmid", "src/util/typerenderer", "jquery"], function (exports) {
  ...
  var _twig = _interopRequireDefault();

  var _typerenderer = _interopRequireDefault();

  var _jquery = _interopRequireDefault();
  ...
  function _getSvgString() {
    _getSvgString = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(parsedGb, options) {
      var svg;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              svg = _context.sent;
              return _context.abrupt("return", (0, _jquery["default"])('<div>').append(svg).html());
  ...
  function _getSvg() {
    _getSvg = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(parsedGb, options) {
      var tmpl, render;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              tmpl = _twig["default"].twig({
  ...
  function _compile() {
    _compile = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(val) {
  ...
  function _plasmidRenderer() {
    _plasmidRenderer = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4($element, val, root, options) {
      var svg;
  ...
  function setTypeRenderer(name) {
    _typerenderer["default"].addType(name, plasmidRenderer);
  }
});