...
define(["exports", "src/util/couchdbAttachments", "../eln/libs/OCLE"], function (exports) {
  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.fetchData = fetchData;

  var _couchdbAttachments = _interopRequireDefault();
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              ca = new _couchdbAttachments["default"](url);
              _context.next = 5;
              return ca.fetchList();
            ...
            case 25:
              ...
              molecule = _OCLE["default"].Molecule.fromMolfile(molfile);
