...
define(["module", "src/util/api", "src/util/ui", "./libs/OCLE", "./libs/MolecularFormula"], function (module, _api, _ui, _OCLE, _MolecularFormula) {
  ...
  var MF = function () {
    ...
    _createClass(MF, [{
      ...
      value: function _mfInfoFromMolfile() {
        ...
        if (molfile) {
          var molecule = _OCLE2["default"].Molecule.fromMolfile(molfile);
