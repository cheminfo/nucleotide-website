...
define(["module"], function (module) {
  function toHTML(value) {
    ...
    if (value && value.peak) {
      if (ascending) {
        ...
        value.peak.sort(function (a, b) {
          return b.wavelength - a.wavelength;
        });
      }
    }
  ...
  function format1(value) {
    ...
    if (value && value.peak) {
      ...
      acsString += value.peak.map(function (a) {
        return Math.round(a.wavelength) + (a.kind ? "<i>".concat(a.kind, "</i>") : '');
      }).join(', ');
    }
  ...
  function format2(value) {
    ...
    if (value && value.peak) {
      ...
      acsString += value.peak.map(function (a) {
        return Math.round(a.wavelength) + (a.kind ? " (".concat(a.kind.toLowerCase(), ")") : '');
      }).join(', ');
    }
