...
define(["exports", "./libs/OCLE", "./libs/OCLUtils", "./libs/SD", "./libs/elnPlugin", "./libs/Image", "./libs/MolecularFormula", "./libs/convertToJcamp", "./libs/parseXY", "./libs/jcampconverter", "./libs/SpectraProcessor"], function (exports, _OCLE, _OCLUtils, _SD, _elnPlugin, _Image, _MolecularFormula, _convertToJcamp, _parseXY, _jcampconverter, _SpectraProcessor) {
